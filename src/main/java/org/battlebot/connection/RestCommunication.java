...
public class RestCommunication {
	 ...
	 * 
	 * @param teamId  identifiant de l'�quipe
	...
	/**
	 * R�cup�ration de l'identifiant de validation de connecttion
	 * 
	...
	/**
	 * Envoie des identifications de connexion pour terminer la proc�dure
	...
	public boolean checkConnection(String botId, String sessionId, String mqttId, String stompId) throws Exception {
		LOGGER.info("V�rification de la connection pour bot " + botId + "(sessionId = " + sessionId + ",mqttId = "
	...
	public boolean move(String botId, String action) throws Exception {
		LOGGER.info("Transmission de se d�placer " + action);
		boolean ok = false;
